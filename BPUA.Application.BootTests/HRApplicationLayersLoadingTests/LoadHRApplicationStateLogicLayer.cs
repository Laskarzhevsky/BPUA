...
namespace BPUA.Application.BootTests
{
    ...
    {
        [Fact]
        public async Task LoadHRApplicationStateLogicLayer()
        {
            ...
            Assert.True(bpuaApplication.ServiceRegistry.TryGetRegisteredObject("HR_Application_SL", out object? value));
