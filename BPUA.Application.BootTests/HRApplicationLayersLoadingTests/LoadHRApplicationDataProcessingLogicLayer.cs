...
namespace BPUA.Application.BootTests
{
    ...
    {
        [Fact]
        public async Task LoadHRApplicationDataProcessingLogicLayer()
        {
            ...
            Assert.True(bpuaApplication.ServiceRegistry.TryGetRegisteredObject("HR_Application_DPL", out object? value));
