...
namespace BPUA.Application.BootTests
{
    ...
    {
        [Fact]
        public async Task LoadHRApplicationDataAccessLogicLayer()
        {
            ...
            Assert.True(bpuaApplication.ServiceRegistry.TryGetRegisteredObject("HR_Application_DAL", out object? value));
