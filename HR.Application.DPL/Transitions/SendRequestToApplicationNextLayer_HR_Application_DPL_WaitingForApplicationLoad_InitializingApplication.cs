...
namespace HR.Application.BL
{
    ...
    public class SendRequestToApplicationNextLayer_HR_Application_DPL_WaitingForApplicationLoad_InitializingApplication : Transition
    {
        ...
        /// Default constructor
        /// </summary>
        public SendRequestToApplicationNextLayer_HR_Application_DPL_WaitingForApplicationLoad_InitializingApplication() : base(RequestName, DomainName, UseCaseName, ApplicationLayerName, StateName, TransitionName)
        {
        }
        #endregion
