...
namespace BPUA.Application.Boot
{
    ...
    public sealed partial class BPUAPlatformBootstrapper
    {
        ...
        void LoadStaticAssemblies()
        {
            ...
            ListOfLoadedAssemblies.Add(typeof(PocoDataSet.BPUAExtensionsAccessLogic.AssemblyReference).Assembly);
            ListOfLoadedAssemblies.Add(typeof(PocoDataSet.BPUAExtensionsProcessingLogic.AssemblyReference).Assembly);
            ListOfLoadedAssemblies.Add(typeof(BPUA.Application.EventHandlers.AssemblyReference).Assembly);
