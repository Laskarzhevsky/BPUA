...
namespace BPUA.Account.BL
{
    ...
    public class LoggingInTransition : Transition
    {
        ...
        public LoggingInTransition(string domainName, string useCaseName, string applicationLayerName, string stateName, string transitionName) : base(domainName, useCaseName, applicationLayerName, stateName, transitionName)
        {
