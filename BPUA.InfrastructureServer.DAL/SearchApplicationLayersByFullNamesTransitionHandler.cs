...
namespace BPUA.InfrastructureServer.DAL
{
    ...
    public partial class SearchApplicationLayersByFullNamesTransitionHandler : BPUA.Application.DataAccessLogic.DataAccessLogicRequestHandler
    {
        ...
        /// Default constructor
        /// </summary>
        public SearchApplicationLayersByFullNamesTransitionHandler() : base(DomainName, UseCaseName, ApplicationLayerName, StateName, TransitionName)
        {
        }
        #endregion
