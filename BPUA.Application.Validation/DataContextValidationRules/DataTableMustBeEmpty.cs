...
{
    /// <summary>
    /// Verifies that data table is empty.
    /// </summary>
    public class DataTableMustBeEmpty : ValidationRule
    {
        #region Constructors
        /// <summary>
        /// Default constructor
        ...
        public DataTableMustBeEmpty(string dataTableName, string requestHandlerTypeFullName) : base(dataTableName, requestHandlerTypeFullName)
        {
        }
        #endregion
        ...
        public override bool Validate(IDataSet? dataContext)
        {
            ...
            {
                dataContext.AddMessage(MessageType.Error, $"{this.GetType().Name}_{DataTableName}", $"Data table {DataTableName} must be empty at transition handler {RequestHandlerTypeFullName}");
                return false;
            }
